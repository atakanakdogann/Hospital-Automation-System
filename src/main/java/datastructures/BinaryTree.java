...
public class BinaryTree < E >
    ...
    /**
     * Preorder traversal
     * @param consumer Consumer function interface
     */
    public void preOrderTraverse(BiConsumer<E, Integer> consumer)
    {
        preOrderTraverse(root, 0, consumer);
    }

    /**
     * Recursive helper function for preOrderTraver(BiConsumer<E, Integer>) funciton
     * @param root Root of the current tree
     * @param depth Depth of the node
     * @param consumer Consumer function interface
     */
    private void preOrderTraverse(Node<E> root, int depth, BiConsumer<E, Integer> consumer)
    {
        if(root == null)
        {
