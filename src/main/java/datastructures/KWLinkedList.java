...
public class KWLinkedList< E extends Comparable<E>> {
  ...
  private void sortBack(Node<E> prevNode, Node<E> currentNode)
  {
      if(prevNode == null || currentNode == null)
          return;

      if(currentNode.data.compareTo(prevNode.data) < 0)
      {
          E temp = currentNode.data;
          currentNode.data = prevNode.data;
          prevNode.data = temp;

          sortBack(prevNode.prev, currentNode.prev);
      }
  }
